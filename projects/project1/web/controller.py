...
from project1.web.mapper import get_dispatcher, get_static_location
...
class AppHandler(SimpleHTTPRequestHandler):
    ...
    def custom_send_response(self, status: int, body: bytes, content_type='text/html'):
        ...
        _log.info("custom_send_response")
    ...
    def send_file(self, file_path: str, text_type='text/html'):
        ...
        if path.exists(file_path):
            ...
            self.custom_send_response(404, b'File not found')
